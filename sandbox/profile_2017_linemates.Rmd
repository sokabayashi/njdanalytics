...
playoff_game_date_start <- game_dates %>% group_by( session_id ) %>% filter( session_id=="4", game_date==min(game_date) ) 
playoff_player_game_number <- playoff_game_date_start$player_game_number

length( playoff_player_game_number )
```
