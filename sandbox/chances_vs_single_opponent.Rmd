...
sc_green_summary_ev <- player_chances_vs_opp_ev %>% filter( metric=="green", last_name=="NJD" ) %>% summarize( scf=sum(scf), sca=sum(sca), sc_net=sum(sc_net), ff=sum(ff), fa=sum(fa), f_net=sum(f_net) )
sc_blue_summary_ev  <- player_chances_vs_opp_ev %>% filter( metric=="blue", last_name=="NJD" ) %>% summarize( scf=sum(scf), sca=sum(sca), sc_net=sum(sc_net), ff=sum(ff), fa=sum(fa), f_net=sum(f_net) )

sc_green_summary_all <- player_chances_vs_opp_all %>% filter( metric=="green", last_name=="NJD" ) %>% summarize( scf=sum(scf), sca=sum(sca), sc_net=sum(sc_net), ff=sum(ff), fa=sum(fa), f_net=sum(f_net) )
sc_blue_summary_all <- player_chances_vs_opp_all %>% filter( metric=="blue", last_name=="NJD" ) %>% summarize( scf=sum(scf), sca=sum(sca), sc_net=sum(sc_net), ff=sum(ff), fa=sum(fa), f_net=sum(f_net) )
