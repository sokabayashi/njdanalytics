...
```
```{r career linemates,fig.width=5.4, fig.height=1.1}
...
p.linemate_season +
  ...
  scale_fill_gradient( low="white", high=few_lightblue, guide=FALSE, space="Lab" ) +
  ...
  theme( 
    ...
    axis.ticks   = element_blank(),
    # plot.margin = unit( c(0.3, 0.2, 0, 0.4), units="lines"), # top right bottoom left
    plot.margin = unit( c(0.3, 2, 0, 0.4), units="lines") # top right bottoom left
    # panel.margin = unit(0,"null")
    ) +
  ggtitle( "Top Linemates (Pct of Player's 5v5 TOI)" ) 
